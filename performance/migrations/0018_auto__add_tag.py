...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Tag'
        db.create_table(u'performance_tag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag_name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('tag_description', self.gf('django.db.models.fields.CharField')(max_length=2048)),
        ))
        db.send_create_signal(u'performance', ['Tag'])
    ...
    def backwards(self, orm):
        # Deleting model 'Tag'
        db.delete_table(u'performance_tag')
    ...
    models = {
        ...
        u'performance.tag': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'samples': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['performance.Sample']", 'symmetrical': 'False'}),
