...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Scenario.scenario_header'
        db.add_column(u'performance_scenario', 'scenario_header',
                      self.gf('django.db.models.fields.CharField')(default='header', max_length=2048),
                      keep_default=False)

        # Adding field 'Sample.sample_value'
        db.add_column(u'performance_sample', 'sample_value',
                      self.gf('django.db.models.fields.TextField')(default='test'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Scenario.scenario_header'
        db.delete_column(u'performance_scenario', 'scenario_header')

        # Deleting field 'Sample.sample_value'
        db.delete_column(u'performance_sample', 'sample_value')
