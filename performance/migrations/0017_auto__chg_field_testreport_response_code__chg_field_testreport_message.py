...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TestReport.response_code'
        db.alter_column(u'performance_testreport', 'response_code', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

        # Changing field 'TestReport.message'
        db.alter_column(u'performance_testreport', 'message', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'TestReport.response_code'
        raise RuntimeError("Cannot reverse this migration. 'TestReport.response_code' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'TestReport.response_code'
        db.alter_column(u'performance_testreport', 'response_code', self.gf('django.db.models.fields.PositiveSmallIntegerField')())

        # Changing field 'TestReport.message'
        db.alter_column(u'performance_testreport', 'message', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))
