...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Fields'
        db.create_table(u'performance_fields', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('field_name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('field_value', self.gf('django.db.models.fields.CharField')(max_length=2048)),
        ...
        db.send_create_signal(u'performance', ['Fields'])


    def backwards(self, orm):
        # Deleting model 'Fields'
        db.delete_table(u'performance_fields')
