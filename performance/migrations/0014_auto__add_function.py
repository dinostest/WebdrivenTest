...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'performance_function', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('func_name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('func_setting', self.gf('django.db.models.fields.CharField')(max_length=2048)),
            ('module', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['performance.Module'])),
        ))
        db.send_create_signal(u'performance', ['Function'])


    def backwards(self, orm):
        # Deleting model 'Function'
        db.delete_table(u'performance_function')
